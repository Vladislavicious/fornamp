...
#исправить ошибку при которая появляется когда удаляем шаг который редактируем
#кнопки добавления были увеличенны из-за бага "мигания" можно попробовать уменьшить шрифт, возможно это решит проблему
